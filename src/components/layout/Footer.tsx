    ...
    <div className="relative h-40 w-full bg-black02 px-[38px] pt-8 font-arial text-[#676767] md:px-[111px]">
      <div className="mx-auto flex max-w-[1200px] flex-wrap justify-center gap-3 overflow-hidden sm:justify-around lg:justify-between">
        ...
        <div className="flex w-fit gap-3">
          <img src="/icons/facebook.svg" alt="페이스북 아이콘" className="h-5 w-5" />
          <img src="/icons/twitter.svg" alt="트위터 아이콘" className="h-5 w-5" />
          <img src="/icons/youtube.svg" alt="유튜브 아이콘" className="h-5 w-5" />
          <img src="/icons/instagram.svg" alt="인스타그램 아이콘" className="h-5 w-5" />
        </div>
      </div>
    </div>
  );
